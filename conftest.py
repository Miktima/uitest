...
import pytest
import allure
import uuid 		#for unique id in screenshots
...
def chrome_options(chrome_options):
    ...
    chrome_options.add_argument('--user-agent=MY/autotest')
    # For Linux
...
#эта функция выпоняется после окончания всех тестов
def pytest_unconfigure(config): 
#@pytest.fixture(scope='session')
    pass
    #print("AFTER ALL TESTS RUN")
    #print('End of pytest')
...
def send_results(request):
    return request.config.getoption("--send_result")
